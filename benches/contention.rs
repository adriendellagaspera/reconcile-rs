...
//!
//! 1. **A counted result**, printed under `internal-testing` and independent of any machine:
...
fn print_counted_summary(_prefill: usize) {
    println!(
        "[contention] Counted half skipped: rebuild with `--features internal-testing` for the \
         machine-independent aggregate-update counts."
    );
}
