...
//!
//! Run with:
//! `cargo test --release -p rbsr --features internal-testing --test the_union_bounds_effective_multiplier -- --ignored --nocapture`
...
use rbsr::oracle_probe::{FingerprintDerivedSplit, SpanRelativeFingerprintSplit};
use rbsr::FixedFanOut;
