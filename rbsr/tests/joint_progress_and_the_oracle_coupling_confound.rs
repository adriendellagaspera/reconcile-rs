...
//! `rbsr::oracle_probe`'s four probes — and separates three questions the original conflated:
//!
...
//!
//! Run with:
//! `cargo test --release -p rbsr --features internal-testing --test joint_progress_and_the_oracle_coupling_confound -- --ignored --nocapture`
