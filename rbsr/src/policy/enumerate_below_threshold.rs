...
/// # Shipped, not the default — but the verdict is conditional
...
/// else: `benches/`, "The Negentropy anchor".
...
/// loss the binding term is `reconcile_interval` per lost datagram instead.
