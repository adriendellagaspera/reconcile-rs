...
/// The default fixed-fan-out refinement policy.
///
/// Mismatching ranges are split into at most `fan_out` children after the shared enumeration
/// cutoffs are applied. [`Default`] uses [`FanOut::NEGENTROPY`].
